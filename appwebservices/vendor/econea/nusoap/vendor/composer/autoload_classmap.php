...
return array(
    ...
    'Foo' => $vendorDir . '/php-parallel-lint/php-parallel-lint/tests/examples/example-05/Foo.php',
    ...
    'XMLSchema' => $baseDir . '/src/nusoap.php',
    'nusoap_base' => $baseDir . '/src/nusoap.php',
    'nusoap_client' => $baseDir . '/src/nusoap.php',
    'nusoap_client_mime' => $baseDir . '/src/nusoapmime.php',
    'nusoap_fault' => $baseDir . '/src/nusoap.php',
    'nusoap_parser' => $baseDir . '/src/nusoap.php',
    'nusoap_server' => $baseDir . '/src/nusoap.php',
    'nusoap_server_mime' => $baseDir . '/src/nusoapmime.php',
    'nusoap_wsdlcache' => $baseDir . '/src/nusoap.php',
    'nusoap_xmlschema' => $baseDir . '/src/nusoap.php',
    'nusoapservermime' => $baseDir . '/src/nusoapmime.php',
    'soap_fault' => $baseDir . '/src/nusoap.php',
    'soap_parser' => $baseDir . '/src/nusoap.php',
    'soap_server' => $baseDir . '/src/nusoap.php',
    'soap_transport_http' => $baseDir . '/src/nusoap.php',
    'soapclient' => $baseDir . '/src/nusoap.php',
    'soapclientmime' => $baseDir . '/src/nusoapmime.php',
    'soapval' => $baseDir . '/src/nusoap.php',
    'wsdl' => $baseDir . '/src/nusoap.php',
    'wsdlcache' => $baseDir . '/src/nusoap.php',
);
